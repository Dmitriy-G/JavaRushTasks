...
public class AdvertisementManager
{
    ...
    public void processVideos() throws NoVideoAvailableException {
        ...
        List<Advertisement> videos = OptimalVideoList(powerLists(temp));
        ...
        StatisticEventManager.getInstance().register(new VideoSelectedEventDataRow(videos,amount,totalDuration));
        ...
        if(videos.size()<=0 || videos.isEmpty()){
