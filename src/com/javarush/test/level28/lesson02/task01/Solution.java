...
public class Solution
{
    ...
    public static void switchTest(Enum obj)
    {
        ...
        switch (obj.getDeclaringClass().toString())
        {
            case "class com.javarush.test.level28.lesson02.task01.Solution$E1":
                System.out.println("it's E1."+obj.name());
                break;
            case "class com.javarush.test.level28.lesson02.task01.Solution$E2":
