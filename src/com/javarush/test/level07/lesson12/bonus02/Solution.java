...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        ArrayList<String> listUpperCas = new ArrayList<String>();

        for (String s : list)
        {
            listUpperCas.add((s.length() % 2 == 0) ? s + " " + s :
                    s + " " + s + " " + s);
        }


        for (int i = 0; i < listUpperCas.size(); i++)
        {
            System.out.println(listUpperCas.get(i));
        }
    }
}
